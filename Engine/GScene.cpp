...
void GScene::Awake()
{
	...
	m_material03.Init(L"S_Fresnel.hlsl", L"T_Blue.jpg");
...
void GScene::Start()
{
	...
	m_cube2.SetScale(0.3f, 0.3f, 0.3f);
	m_cube2.SetRotation(90, 0, 0);
	m_cube2.SetPosition(2, -0.5f, 0);
...
void GScene::LateUpdate()
{
	...
	m_material03.Render(m_cube2.GetWorldMatrix());
	m_cube2.Render();
	m_cube2.Update();
}
